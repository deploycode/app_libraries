...
//echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/app_libraries/Config.yaml');
...
elseif(_AMBIENTE == 3) //pruebas locales
{
    $iBd = 'dbPruebasLocales';
}

$arrBdIntegral = $arrConfig[$iBd]['Integral'];
